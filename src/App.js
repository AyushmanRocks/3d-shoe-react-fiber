...
function Model({ ...props }) {
  const group = useRef()
  const { nodes, materials } = useGLTF('/mens_jeans_1.glb');
  console.log(nodes);
  ...
  const showModel = () => {
    return Object.keys(nodes).filter(node => (
      ...
      return <mesh geometry={nodes[obj].geometry} material={materials.Trousers3} material-color={props.customColors.setStripes}/>
    })
  }

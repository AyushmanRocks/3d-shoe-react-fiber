...
let design = anime({
  ...
  return (
    ...
    <div className="fullBody">
      <div className="mydesign dust-paarticle">
        <svg
          width="100%"
          id="dust-paarticle"
          height="100%"
                  ...
                  <div className="authfy-panel panel-login text-center active">
                    <div className="authfy-heading">
                      ...
                      <p>
                        ...
                        <Link class="lnk-toggler" data-panel=".panel-signup" to="/signup">Sign Up Free!</Link>
                      </p>
                    </div>
                    <div className="row">
                       ...
                       {({ values, handleChange, handleSubmit }) => (
                          ...
                          <div className="form-group">
                              <Button type="submit"
                                color="secondary"
                                variant="contained"
                                sx={{ mt: 1, height: "50px", fontSize: "1.2rem" }}
                                className="btn btn-lg btn-primary-login btn-block">
                                Login Now
                              </Button>
                          </div>
                        </form>
